                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="status" value="pengumuman" hidden>
                      <textarea name="pengumuman" id="pengumuman" class="form-control" cols="100" rows="5"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="status" value="infoppdb" hidden>
                      <input type="text" name="deskripsi_ppdb" class="form-control">
                      <label>Tanggal</label>
                      <input type="text" name="tgl_ppdb" class="form-control">
                    </div>
                  </div>
                </div>
                &nbsp; &nbsp;<input class="btn btn-primary btn-sm" name="tambah" type="submit" value="Tambah">
