  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
      ...
      ?>
        ...
        <?php } else { ?>
        <img class="user-image img-circle elevation-2" src="../../assets/image/foto_siswa/<?= $data['foto']; ?>"  alt="User Image">
        <?php }?>
            ...
            <span class="d-none d-lg-inline-block"><?= $data['nama_siswa']; ?></span> 
